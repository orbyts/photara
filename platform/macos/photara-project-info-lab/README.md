# Photara Project Info Lab

Independent native authoring host for `../photara-project-info`. It compiles production
...
Follow the shared [`DESIGN_LANGUAGE.md`](../DESIGN_LANGUAGE.md). This lab owns Project
Info assignments, editors and states only; Shell/Theme own its module frame, shared
