# Shared Scenes module

Photara and [the Scenes Lab](../photara-scenes-lab/README.md) compile these exact
...
Change shared sources here to author Scenes, then rebuild the lab and Photara.
