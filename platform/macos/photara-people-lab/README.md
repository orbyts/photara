...
Independent native authoring host for `../photara-people`. It compiles production
...
Follow the shared [`DESIGN_LANGUAGE.md`](../DESIGN_LANGUAGE.md). This lab owns People
