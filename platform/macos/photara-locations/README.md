# Shared Locations module

Photara and [the Locations Lab](../photara-locations-lab/README.md) compile these exact
...
Change shared sources here to author Locations, then rebuild the lab and Photara.
